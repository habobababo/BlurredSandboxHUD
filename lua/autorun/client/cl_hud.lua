...
local function CoreHud()
	...
	if secammo > 0 then
		draw.RoundedBox(4, ScrW() - 44,ScrH() - 73, 50,32, Color(0, 0, 0,100))
		draw.SimpleTextOutlined( secammo,"ammof",ScrW() - 38,ScrH() - 72, Color( 200,200,200,255 ),TEXT_ALIGN_LEFT,0,1,Color( 0,0,0,60 ))-- THE TEXT WITHIN THE BOX
	end
